        ...
        a.fn.zclip = function (b) {
            if ("object" == typeof b && !b.length) {
                ...
                return this.each(function () {
                    ...
                    if (b.is(":visible") && ("string" == typeof c.copy || a.isFunction(c.copy))) {
                        ...
                        a.isFunction(c.copy) && b.bind("zClip_copy", c.copy), a.isFunction(c.beforeCopy) && b.bind("zClip_beforeCopy", c.beforeCopy), a.isFunction(c.afterCopy) && b.bind("zClip_afterCopy", c.afterCopy), d.setHandCursor(c.setHandCursor), d.setCSSEffects(c.setCSSEffects), d.addEventListener("mouseOver", function () {
                            b.trigger("mouseenter")
                        }), d.addEventListener("mouseOut", function () {
                            b.trigger("mouseleave")
                        }), d.addEventListener("mouseDown", function () {
                            b.trigger("mousedown"), a.isFunction(c.beforeCopy) && b.trigger("zClip_beforeCopy"), a.isFunction(c.copy) ? d.setText(b.triggerHandler("zClip_copy")) : d.setText(c.copy)
            ...
            return "string" == typeof b ? this.each(function () {
                ...
                var d = c.data("zclipId"),
                    e = a("#" + d + ".zclip"),
                    f = e.attr("id").replace(/^.*_/g, "") || null;
                "remove" == b ? (e.remove(), c.removeClass("active hover"), c.unbind("zClip_copy"), c.unbind("zClip_beforeCopy"), c.unbind("zClip_afterCopy"), ZeroClipboard.unregister(f)) : "hide" == b ? (e.hide(), c.removeClass("active hover")) : "show" == b && e.show()
            }) : void 0
        }
    }(jQuery);
var ZeroClipboard = {
    ...
    unregister: function (a) {
        "number" == typeof a && this.clients.hasOwnProperty(a) && delete this.clients[a]
    },
...
ZeroClipboard.Client.prototype = {
        ...
        handlers: null,
        glue: function (a, b, c) {
            this.domElement = ZeroClipboard.jQuery(a);
            var d = 99;
            this.domElement.style.zIndex && (d = parseInt(this.domElement.style.zIndex, 10) + 1), "string" == typeof b ? b = ZeroClipboard.jQuery(b) : "undefined" == typeof b && (b = document.getElementsByTagName("body")[0]);
            var e = ZeroClipboard.getDOMObjectPosition(this.domElement, b);
            this.div = document.createElement("div"), this.div.className = "zclip", this.div.id = "zclip-" + this.movieId, jQuery(this.domElement).data("zclipId", "zclip-" + this.movieId);
        ...
        reposition: function (a) {
            if (a && (this.domElement = ZeroClipboard.jQuery(a), this.domElement || this.hide()), this.domElement && this.div) {
        ...
        receiveEvent: function (a, b) {
            ...
            case "load":
                ...
                var c = this;
                if (!this.movie) return setTimeout(function () {
                    c.receiveEvent("load", null)
                }, 1), void 0;
                if (!this.ready && navigator.userAgent.match(/Firefox/) && navigator.userAgent.match(/Windows/)) return setTimeout(function () {
                    c.receiveEvent("load", null)
    ...
    function (a, b) {
        ...
        var c = "",
                    ...
                    for (var a, c, d, h, i, j, k, l = 0, m = arguments; l < m.length; l += 2) {
                        ...
                        for (c = d = 0; c < n.length; c++)
                            if (j = n[c].exec(this.getUA())) {
                                for (h = 0; h < o.length; h++) k = j[++d], i = o[h], typeof i === g && i.length > 0 ? 2 == i.length ? a[i[0]] = typeof i[1] == e ? i[1].call(this, k) : i[1] : 3 == i.length ? a[i[0]] = typeof i[1] !== e || i[1].exec && i[1].test ? k ? k.replace(i[1], i[2]) : b : k ? i[1].call(this, k, i[2]) : b : 4 == i.length && (a[i[0]] = k ? i[3].call(this, k.replace(i[1], i[2])) : b) : a[i] = k ? k : b;
                                break
                            }
                        if (j) break
                    }
            ...
            v = function (b) {
                ...
                return this instanceof v ? (this.getBrowser = function () {
                    ...
                    return d = a, this
                }, this.setUA(d), void 0) : new v(b).getResult()
            };
        if (typeof exports !== f) typeof module !== f && module.exports && (exports = module.exports = v), exports.UAParser = v;
        else if (a.UAParser = v, typeof define === e && define.amd && define(function () {
            return v
        }), typeof a.jQuery !== f) {
            var w = a.jQuery,
                x = new v;
    ...
    function (a, b) {
        var c = a(this),
            d = c.scrollTop() || b.pageYOffset,
            e = !1,
            f = function () {
                return !!("ontouchstart" in b) || !!("onmsgesturechange" in b)
            },
            g = {
                init: function (b) {
                    return this.each(function () {
                        ...
                        if ("undefined" == typeof h) {
                            ...
                            h = a.extend({}, i, b), e.data("hook", h)
                        } else h = a.extend({}, h, b); if (h.dynamic === !0) {
                            var j = "<div class=" + h.loaderClass + ">";
                            j += "<div class=" + h.spinnerClass + "/>", j += "</div>";
                            var k = "<span class=" + h.loaderTextClass + ">" + h.loaderText + "</span>";
                            e.append(j), h.textRequired === !0 && (e.addClass("hook-with-text"), e.append(k))
                        }
                        if (f()) {
                            var l = 0,
                                m = 0;
                            c.on("touchstart", function (a) {
                                ...
                                m = b.originalEvent.touches[0].pageY + l, d = a(this).scrollTop(), m < h.swipeDistance && b.preventDefault(), m > h.swipeDistance && 40 >= l && g.onSwipe(e, h)
                            }), c.on("touchend", function () {
                                m = 0
                            })
                        } else h.scrollWheelSelected === !0 ? c.on("mousewheel", function (a, b) {
                            g.onScroll(e, h, b)
                ...
                onScroll: function (a, b, f) {
                    d = c.scrollTop(), b.scrollWheelSelected === !0 && f >= 150 && 0 >= d && e === !1 && (g.reload(a, b), e = !0), b.scrollWheelSelected === !1 && 0 >= d && e === !1 && (g.reload(a, b), e = !0)
                },
                ...
                reload: function (a, c) {
                    a.show(), a.animate({
                        marginTop: "0px"
                    }, 200), a.delay(500).slideUp(200, function () {
                        c.reloadPage && b.location.reload(!0), e = !1
                    }), c.reloadPage || c.reloadEl()
                },
                destroy: function () {
                    return a(this).each(function () {
                        var b = a(this);
                        b.empty(), b.removeData("hook")
                    })
                }
            };
        a.fn.hook = function () {
            var b = arguments[0];
            if (g[b]) b = g[b], arguments = Array.prototype.slice.call(arguments, 1);
            else {
                if ("object" != typeof b && b) return a.error("Method " + b + " does not exist on jQuery.pluginName"), this;
                b = g.init
            }
    ...
    function () {
        ...
        function e(a, b, c) {
            var d, e = b.indexOf("$") <= 1 ? !0 : !1,
                f = "";
            return b.indexOf(" $") > -1 ? (f = " ", b = b.replace(" $", "")) : b.indexOf("$ ") > -1 ? (f = " ", b = b.replace("$ ", "")) : b = b.replace("$", ""), d = i(a._value, b, c), e ? d.indexOf("(") > -1 || d.indexOf("-") > -1 ? (d = d.split(""), d.splice(1, 0, m[n].currency.symbol + f), d = d.join("")) : d = m[n].currency.symbol + f + d : d.indexOf(")") > -1 ? (d = d.split(""), d.splice(-1, 0, f + m[n].currency.symbol), d = d.join("")) : d = d + f + m[n].currency.symbol, d
        }
        ...
        function g(a) {
            var b = Math.floor(a._value / 60 / 60),
                c = Math.floor((a._value - 3600 * b) / 60),
                d = Math.round(a._value - 3600 * b - 60 * c);
        ...
        function h(a) {
            var b = a.split(":"),
                c = 0;
            return 3 === b.length ? (c += 3600 * Number(b[0]), c += 60 * Number(b[1]), c += Number(b[2])) : 2 === b.length && (c += 60 * Number(b[0]), c += Number(b[1])), Number(c)
        }
        ...
        function i(a, c, d) {
            var e, f, g, h, i, j, k = !1,
                ...
                v = "",
                w = !1;
            if (0 === a && null !== o) return o;
            if (c.indexOf("(") > -1 ? (k = !0, c = c.slice(1, -1)) : c.indexOf("+") > -1 && (l = !0, c = c.replace(/\+/g, "")), c.indexOf("a") > -1 && (c.indexOf(" a") > -1 ? (q = " ", c = c.replace(" a", "")) : c = c.replace("a", ""), t >= Math.pow(10, 12) ? (q += m[n].abbreviations.trillion, a /= Math.pow(10, 12)) : t < Math.pow(10, 12) && t >= Math.pow(10, 9) ? (q += m[n].abbreviations.billion, a /= Math.pow(10, 9)) : t < Math.pow(10, 9) && t >= Math.pow(10, 6) ? (q += m[n].abbreviations.million, a /= Math.pow(10, 6)) : t < Math.pow(10, 6) && t >= Math.pow(10, 3) && (q += m[n].abbreviations.thousand, a /= Math.pow(10, 3))), c.indexOf("b") > -1)
                for (c.indexOf(" b") > -1 ? (r = " ", c = c.replace(" b", "")) : c = c.replace("b", ""), g = 0; g <= u.length; g++)
                    if (e = Math.pow(1024, g), f = Math.pow(1024, g + 1), a >= e && f > a) {
                        r += u[g], e > 0 && (a /= e);
                        break
                    }
            return c.indexOf("o") > -1 && (c.indexOf(" o") > -1 ? (s = " ", c = c.replace(" o", "")) : c = c.replace("o", ""), s += m[n].ordinal(a)), c.indexOf("[.]") > -1 && (p = !0, c = c.replace("[.]", ".")), h = a.toString().split(".")[0], i = c.split(".")[1], j = c.indexOf(","), i ? (i.indexOf("[") > -1 ? (i = i.replace("]", ""), i = i.split("["), v = b(a, i[0].length + i[1].length, d, i[1].length)) : v = b(a, i.length, d), h = v.split(".")[0], v = v.split(".")[1].length ? m[n].delimiters.decimal + v.split(".")[1] : "", p && 0 === Number(v.slice(1)) && (v = "")) : h = b(a, null, d), h.indexOf("-") > -1 && (h = h.slice(1), w = !0), j > -1 && (h = h.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1" + m[n].delimiters.thousands)), 0 === c.indexOf(".") && (h = ""), (k && w ? "(" : "") + (!k && w ? "-" : "") + (!w && l ? "+" : "") + h + v + (s ? s : "") + (q ? q : "") + (r ? r : "") + (k && w ? ")" : "")
        }
        ...
        k = function (b) {
            ...
            format: function (a, b) {
                return c(this, a ? a : p, void 0 !== b ? b : Math.round)
            },
            unformat: function (a) {
                return "[object Number]" === Object.prototype.toString.call(a) ? a : d(this, a ? a : p)
            },
            value: function () {
                return this._value
            },
            ...
            add: function (a) {
                return this._value = this._value + Number(a), this
            },
            subtract: function (a) {
                return this._value = this._value - Number(a), this
            },
